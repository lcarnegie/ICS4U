...
let x = 300;
let y = 100;
let dx = 20 * Math.pow(scale, -1); //speed of circle being drawn (or how many pixels are being added to x every time you draw the circle again) 
let dy = 20 * Math.pow(scale, -1);
let radius = 20 * scale;
let stop = false;
